...
import ConfigurationInput from '/experiments_new/experiment/piano3d/Piano3DInput';
...
export default function DroneRingMap() {
  ...
  this.storeResolutionMin = 0.02; // for all strategies
  this.storeResolutionMax = 0.05; // for all strategies
